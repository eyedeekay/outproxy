...
//SetTargetForPort sets the port of the OutProxy's SAM bridge using a string
/*func SetTargetForPort443(s string) func(*OutProxy) error {
	return func(c *OutProxy) error {
		port, err := strconv.Atoi(s)
		if err != nil {
